    ...
    return (
      <>
        ...
        <form onSubmit={(e) => this.handleSubmit(e)} className="form">
          ...
          {this.state.invalidForm.birthday && (
            <ErrorMessage text={'The birthday must not be empty'} />
          )}
          <label htmlFor="profilePicture">profile picture</label>
          <input type="file" ref={this.profilePicture} placeholder="profile picture" />
          {this.state.invalidForm.profilePicture && <ErrorMessage text={'Add file'} />}
          <div>
            gender:
